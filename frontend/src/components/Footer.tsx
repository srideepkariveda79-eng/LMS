    ...
    <footer className={footerStyles.footer}>
        ...
        <div className={footerStyles.container}>
            <div className={footerStyles.grid}>
                <div className={footerStyles.bransSection}>
                    <div className={footerStyles.brandTransform}>
                        <div className={footerStyles.brandContainer}>
                            ...
                            <div className='relative font-serif flex items-center gap-3'>
                                <img src={arohakLogo} alt="AROHAK" className='h-14 w-auto' />
                            </div>
                           </div>
                ...
                <div>
                    ...
                    <ul className={footerStyles.linksList}>
                        ...
                        {/*support*/}
                <div>
                    <h4 className={`${footerStyles.sectionHeader} ${iconColors.blue}`}> 
                    ...
                    <ul className={footerStyles.linksList}>
                        {supportLinks.map((link, index) => {
                            ...
                            return (
                                <li key={link.name}>
                                <a href={link.href}
                                    className={`${footerStyles.linkItem} ${iconColors.blue}`}
                                    style={{
                                        transitionDelay: `${index * 80}ms`,
                                    }}                                    >
                                        <Icon className={`${footerStyles.linkIcon} ${iconColors.blue}`} />
                                        <span className='truncate'>
                                            {link.name}
                                        </span>
                                </a>
                            ...
                            <div className={footerStyles.contactItem}>
                             ...
                             <div className={footerStyles.contactItem}>
                                <div className={`${footerStyles.contactIconContainer} ${contactIconGradients.phone}`}>
                                    <Phone className={`${footerStyles.contactIcon} ${iconColors.blue600}`} />
